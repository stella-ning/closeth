...
class TemplateApp extends BackendApp
{
    ...
    function _get_editable_pages()
    {
        ...
        return array(
        	...
        	'search_stores' => $real_site_url . '/index.php?app=search&act=store',
        	'search_newgoods' => $real_site_url . '/index.php?app=search&act=newgoods',
        	'search_goods' => $real_site_url . '/index.php?app=search&act=index',
        	'behalf_goods' => $real_site_url . '/index.php?app=behalf_goods&act=index',
			'behalf_realzone' => $real_site_url . '/index.php?app=behalf_realzone&act=index',
        	'goods_detail' => $real_site_url . '/index.php?app=default&act=show_goods_detail_advs',
        	'foreign' => $real_site_url . '/index.php?app=foreign',
        	'goldstores' => $real_site_url . '/index.php?app=goldstores',
        	'slease' => $real_site_url . '/index.php?app=slease',
            
            //'member_center'=> $real_site_url .'/index.php?app=message&act=newpm',
        );
    }
}
