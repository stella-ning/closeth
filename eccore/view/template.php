        ...
        else
        {
            ...
            switch ($tag_sel)
            {
               ...
               case 'imqq':
                    	...
                    	$ahref1 = '<a href="http://wpa.qq.com/msgrd?v=3&uin='.'<?php echo urlencode(trim('.$uin.')); ?>'.
                    		'&site='.'<?php echo '.$site.'; ?>'.'&menu=yes" target="_blank" title="<?php echo trim('.$uin.') ?>" style="display:inline-block;width:16px;overflow:hidden;vertical-align:middle;">
                    		<img src="http://wpa.qq.com/pa?p=1:'.'<?php echo urlencode(trim('.$uin.')); ?>'.':9" alt="QQ">
                    		</a>';
                    	
                    	$ahref2 ='<a href="http://crm2.qq.com/page/portalpage/wpa.php?uin=800063451&aty=1&a='.'<?php echo urlencode(trim('.$uin.')); ?>'.
                    				'&curl=&ty=1" title="800063451" style="display:inline-block;width:16px;overflow:hidden;vertical-align:middle;"><img src="http://wpa.qq.com/pa?p=1:800063451:9" alt="QQ"></a>';
                  ...
                  case 'addstar':
                    ...
                    case 'date':
                        ...
                        else
                        {
                            ...
                            }else  if (in_array($s[1], array('goods')) )
                            {
                                $date_format = Conf::get("time_format_simple");
                                /* 允许使用简单和完整格式，从配置项中取 */
                               Conf::get("time_format_{$s[1]}")&& $date_format = Conf::get("time_format_{$s[1]}");
                                $p = $p.' - 8*3600';
                            }
                            else
                            {
