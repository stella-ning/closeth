...
class PHPZip{
    ...
    function createZip($dir, $zipfilename, $autoDownload = false,$dir_del1,$dir_del2,$outname)
    {
        ...
        if (@function_exists('gzcompress'))
        {
            ...
            $zipfilenametemp = $dir.$zipfilename;


            //$zipfilenametemp = "temp".$zipfilename;
            //echo "zipfilenametemp=".$zipfilenametemp."<br>";
            $out = $this -> filezip();
            //$out="hello";
            ...
            if ($filesize < 104857600)
            {
                if($autoDownload)
                {
                    ...
                    //echo "dir_1:".$dir_del1."<br>";
                    //echo "dir_2:".$dir_del2."<br>";
                    //$this ->deldir($dir_del1);
                    //$this ->deldir($dir_del2);
                    //echo "test4="."<br>";
                }
                //echo $this -> filezip();
    ...
    function downloadZip($dir, $zipfilename, $autoDownload = true,$dir_del1,$dir_del2,$outname)
    {
        $this->createZip($dir, $zipfilename, true,$dir_del1,$dir_del2,$outname);
        // echo "dir1=".$dir."<br>";
    }
