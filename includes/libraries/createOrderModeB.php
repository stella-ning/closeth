<?php
/*
   File name: CreateOrderModeB
   Author: tanaiquan 2015/08/13
*/
include 'byte.php';
class CreateOrderModeB{
    //订单号 -
    var $clientId = "K200225829";//"K24000154";
    var $customerId = "K200225829";
    var $parternId = "3dv20UFA";//'weH71Rbq';
    var $req_url = 'http://58.32.246.71:8000/CommonOrderModeBServlet.action';
    //数据
    var $order = array();
    var $string;
    var $data_digest;
    ...
    function __CreateOrderModeB($clientId,$parternId,$req_url)
    {
        $this->CreateOrderModeB($clientId,$parternId,$req_url);
    }

    function CreateOrderModeB($clientId,$parternId,$req_url)
    {
