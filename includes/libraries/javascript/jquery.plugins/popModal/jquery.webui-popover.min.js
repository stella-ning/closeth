...
!function (a, b, c) {
    ...
    var e = "webuiPopover", f = "webui-popover", g = "webui.popover", h = {
        ...
        url: "",
        type: "html",
        template: '<div class="webui-popover"><div class="arrow"></div><div class="webui-popover-inner"><h3 class="webui-popover-title"></h3><div class="webui-popover-content"><i class="glyphicon glyphicon-refresh"></i> <p></p></div></div></div>'
    };
    d.prototype = {
        init: function () {
            ...
            var b = this.getElementPosition(), d = this.getTarget().removeClass().addClass(f),
            ...
            var d, e = c.documentElement, f = c.body, g = e.clientWidth, h = Math.max(f.scrollTop, e.scrollTop),
                i = Math.max(f.scrollLeft, e.scrollLeft), j = Math.max(0, a.left - i), k = Math.max(0, a.top - h),
                l = 20;
