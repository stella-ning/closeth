            ...
            $.get(selfurl + "&act=ajax_cate", {id: id}, function(data){
                if(data)
                {
                    ...
                    for(var i = 0; i < res.length; i++)
                    {
                        ...
                        "<td class='node' width='50%'><img class='preimg' src='templates/style/images/treetable/vertline.gif'/>"+src+"<span class='node_name editable' ectype='inline_edit' fieldname='cate_name' fieldid='"+res[i].cate_id+"' required='1'>"+res[i].cate_name+"</span>"+"<span class='node_name editable' ectype='inline_edit' fieldname='cate_mname' fieldid='"+res[i].cate_id+"' required='1'>"+res[i].cate_mname+"</span>"+"</td>"+
                ...
                if(data)
                {
                    ...
                    for(var i = 0; i < res.length; i++)
                    {
                        ...
                        if(res[i].switchs)
                        {
                           ...
                           +"<span class='node_name editable' ectype='inline_edit' fieldname='cate_mname' fieldid='"+res[i].cate_id+"' required='1'>"+res[i].cate_mname+"</span>";
