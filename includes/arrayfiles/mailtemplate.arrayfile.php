...
class MailtemplateArrayfile extends BaseArrayfile
{
    ...
    {
        return array(
               'sms_money_notify'=> array(
                'description' => Lang::get('sms_money_notify_desc'),
            ),
             'sms_order_notify'=> array(
                'description' => 'site money change notify!',
            ),
            'tobehalf_new_order_notify'=> array(
                'description' => Lang::get('tobehalf_new_order_notify_desc'),
            ),
            ...
            'touser_find_password' => array(
             ...
             'touser_find_password_onlyZ' => array(
                'description' =>
                Lang::get('touser_find_password_desc'),
            ),
