...
<p style="padding-left: 30px;">登陆密码修改请点击：<a href="{$site_url}/index.php?app=find_password&act=set_password&id={$user.user_id}&activation={$word}">{$site_url}/index.php?app=find_password&act=set_password&id={$user.user_id}&activation={$word}</a></p>
<BR>
