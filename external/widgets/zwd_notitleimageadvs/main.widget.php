 ...
 */
class Zwd_notitleimageadvsWidget extends BaseWidget
{
    var $_name = 'zwd_notitleimageadvs';
	var $_ttl  = 1800;
            ...
            for ($i = 0; $i < $num ; $i++)
            {
                ...
                if (!empty($input['ad_image_url'][$i]))
                {
                    $result['images'][] = array(
                    	...
                    	'ad_width' => $input['ad_width'][$i],
                    	'ad_height' => $input['ad_height'][$i],
                    	'ad_margin' => $input['ad_margin'][$i],
                    );
                }
            }
        }
